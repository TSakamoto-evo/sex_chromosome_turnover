...
int main(int argc, char *argv[]){
  ...
  std::cout << n << "\t" << sf << "\t" << hf << "\t" << sm << "\t" << hm << "\t" << rf << "\t" << u << "\t" << v << std::endl;
  ...
  while(getline(ifs, str)){
    ...
    reps++;
    if((regi_w_fix >= max_rep && reps % 10000 == 0) || reps == 2000000){
      break;
    }
  }
  ofs << n << "\t" << sf << "\t" << hf << "\t" << sm << "\t" << hm << "\t" << rf << "\t" << max_rep << "\t1\t";
  ofs << regi_w_fix * 1.0 / reps << "\t" << regi_w_fix << "\t" << reps << "\t" << u << "\t" << v << std::endl;
